...
$danhmuc_slug =$_GET['danhmuc'];
$danhmuc_pr = getslugActivetype("tbl_danhmuc",$danhmuc_slug);
$danhmuc = mysqli_fetch_array($danhmuc_pr);
$type_id = $danhmuc['id_danhmuc'];
            ...
            <div class="col-lg-8">
                <div class="breadcrumb_iner">
                    <div class="breadcrumb_iner_item">
                        <h2>Shop Category</h2>
                        <p>Home <span>-</span> Shop Category <span>-</span><?=$danhmuc['tendanhmuc']?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <div class="row align-items-center latest_product_inner">
                        <?php
                        $products = getProdBytype($type_id,$start, $limit);
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        if ($current_page > 1 && $total_page > 1){
                                            echo '<a href="product_type.php?page='.($current_page-1).'">Prev</a> | ';
                                        }
                                        ...
                                        for ($i = 1; $i <= $total_page; $i++){
                                            ...
                                            if ($i == $current_page){
                                                ...
                                                echo '<a href="product_type.php?page='.$i.'">'.$i.'</a> | ';
                                            }
                                        }

                                        // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
                                        if ($current_page < $total_page && $total_page > 1){
                                            echo '<a href="product_type.php?page='.($current_page+1).'">Next</a> | ';
                                        }
                                        ?>
                                    </ul>
                                </nav>
