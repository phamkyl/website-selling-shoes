            ...
            <div class="col-lg-8">
                <div class="breadcrumb_iner">
                    <div class="breadcrumb_iner_item">
                        <h2>Shop Category</h2>
                        <p>Home <span>-</span> Shop Category<span>-</span> Thông tin vận chuyển</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
    ...
    if(isset($_SESSION['id_khachhang'])){
        ...
        <div class="arrow-steps clearfix shop-cart">
    ...
    if(isset($_POST['themvanchuyen'])) {
        ...
        $sql_them_vanchuyen = mysqli_query($con,"INSERT INTO tbl_shipping(name,phone,address,note,id_dangky) VALUES('$name','$phone','$address','$note','$id_dangky')");
        ...
        $note = $_POST['note'];
        $id_dangky = $_SESSION['id_khachhang'];
        $sql_update_vanchuyen = mysqli_query($con,"UPDATE tbl_shipping SET name='$name',phone='$phone',address='$address',note='$note',id_dangky='$id_dangky' WHERE id_dangky='$id_dangky'");
            ...
            <table style="border-collapse:collapse; ">
                ...
                if(isset($_SESSION['cart'])){
                    ...
                    foreach($_SESSION['cart'] as $cart_item){
                        ...
                        <td>
                            <img src="../admin/uploads/<?php echo $cart_item['image'];?>" width="150px" />

                        </td>
                        <td><?php echo $cart_item['name']; ?></td>
                        <td><?php echo number_format($cart_item['selling_price'],0,',','.').'vnđ'; ?></td>
                        <td>
                            <a href="../USERS/cart_tt.php?tru=<?php echo $cart_item['id'] ?>"><i class="ti-minus" aria-hidden="true"></i></a>
                            <?php echo $cart_item['soluong']; ?>
                            <a href="../USERS/cart_tt.php?cong=<?php echo $cart_item['id'] ?>"><i class="ti-plus" aria-hidden="true"></i></a>

                        </td>

                        <td><?php echo number_format($thanhtien,0,',','.').'vnđ' ?></td>
                        <td><a href="../USERS/cart_tt.php?xoa=<?php echo $cart_item['id'] ?>">Xoá</a></td>
                        </tr>
                    ...
                    <tr>
                        <td colspan="8">
                            ...
                            if(isset($_SESSION['dangky'])){
                                ?>
                                <p><a href="thongtindathang.php">Thông tin thanh toán</a></p>
                                <?php
                            }else{
                                ?>
